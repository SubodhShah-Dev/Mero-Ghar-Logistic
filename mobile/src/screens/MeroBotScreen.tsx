...
const styles = StyleSheet.create({
  ...
  questionChip: { backgroundColor: COLORS.forest[800], borderWidth: 1, borderColor: COLORS.forest[600], borderRadius: 8, paddingHorizontal: 10, paddingVertical: 7, minHeight: 44, justifyContent: 'center' },
  ...
  questionsBtn: { borderWidth: 1, borderColor: COLORS.forest[600], borderRadius: 8, paddingHorizontal: 10, paddingVertical: 9, minHeight: 44, justifyContent: 'center' },
  questionsBtnActive: { borderColor: COLORS.saffron[400], backgroundColor: 'rgba(79,70,229,0.15)' },
  questionsBtnText: { color: COLORS.forest[300], fontSize: 12, fontWeight: '600' },
  questionsBtnTextActive: { color: COLORS.saffron[300] },
  input: { flex: 1, backgroundColor: COLORS.forest[800], borderWidth: 1, borderColor: COLORS.forest[600], borderRadius: 8, color: COLORS.cream[50], paddingHorizontal: 12, paddingVertical: 10, fontSize: 14, minHeight: 44 },
  sendBtn: { backgroundColor: COLORS.saffron[400], borderRadius: 8, paddingHorizontal: 16, paddingVertical: 10, minHeight: 44, justifyContent: 'center' },
