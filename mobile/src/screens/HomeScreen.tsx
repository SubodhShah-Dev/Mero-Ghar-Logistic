...
const styles = StyleSheet.create({
  ...
  primaryBtn: { backgroundColor: COLORS.saffron[400], paddingHorizontal: 28, paddingVertical: 14, borderRadius: 4, minHeight: 48, justifyContent: 'center', alignItems: 'center' },
  primaryBtnText: { color: COLORS.forest[900], fontWeight: '700', fontSize: 16 },
  secondaryBtn: { borderWidth: 1, borderColor: COLORS.forest[600], paddingHorizontal: 28, paddingVertical: 14, borderRadius: 4, minHeight: 48, justifyContent: 'center', alignItems: 'center' },
  secondaryBtnText: { color: COLORS.forest[300], fontSize: 15 },
  quickLinks: { gap: 12, width: '100%' },
  linkBtn: { backgroundColor: COLORS.forest[800], paddingHorizontal: 20, paddingVertical: 14, borderRadius: 4, alignItems: 'center', minHeight: 48, justifyContent: 'center' },
  ...
  section: { padding: 16 },
  sectionTitle: { color: COLORS.cream[50], fontSize: 24, fontWeight: '900', marginBottom: 16, textAlign: 'center' },
  ...
  stepNumLast: { backgroundColor: 'rgba(79,70,229,0.10)' },
