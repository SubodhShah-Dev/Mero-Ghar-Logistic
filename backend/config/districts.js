// Single source of truth for the 77 districts (mirrors mobile/src/utils/nepal.ts).
// Keep in sync with the mobile dataset.
...
export const DISTRICTS = [
	...
	{ province_id: 1, name: 'Khotang' },
	{ province_id: 1, name: 'Morang' },
	{ province_id: 1, name: 'Okhaldhunga' },
	{ province_id: 1, name: 'Panchthar' },
	{ province_id: 1, name: 'Sankhuwasabha' },
	{ province_id: 1, name: 'Solukhumbu' },
	{ province_id: 1, name: 'Sunsari' },
	{ province_id: 1, name: 'Taplejung' },
	{ province_id: 1, name: 'Terhathum' },
	{ province_id: 1, name: 'Udayapur' },
	{ province_id: 2, name: 'Bara' },
	{ province_id: 2, name: 'Dhanusha' },
	{ province_id: 2, name: 'Mahottari' },
	{ province_id: 2, name: 'Parsa' },
	...
	{ province_id: 5, name: 'Nawalparasi West' },
